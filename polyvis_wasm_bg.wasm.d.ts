...
export const instance_add_polygon: (a: number, b: number, c: number) => [number, number, number];
export const instance_mod_polygon: (a: number, b: number, c: number, d: number) => [number, number];
...
export const instance_polygons_under_coord: (a: number, b: number) => [number, number];
